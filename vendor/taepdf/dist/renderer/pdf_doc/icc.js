...
function xyzType(x, y, z) {
  return pad4(
    concat(tag4("XYZ "), be32(0), s15Fixed16(x), s15Fixed16(y), s15Fixed16(z)),
  );
}
function curvType(gamma) {
  return pad4(
    concat(tag4("curv"), be32(0), be32(1), be16(Math.round(gamma * 256))),
  );
}
var cached = null;
function buildSRGBProfile() {
  ...
  const tags = [
    [
      "cprt",
      textType(
        "Public Domain, generated by taepdf (approximate sRGB, single-gamma TRC)",
      ),
    ],
  ...
  const profile = concat(
    header,
    be32(tags.length),
    concat(...tagTableEntries),
    concat(...tagDataParts),
  );
  cached = profile;
  return profile;
}
export { buildSRGBProfile };
